...
//   node wa/list-group-participants.mjs 1203630XXXXXXXXXX@g.us
//   node wa/list-group-participants.mjs --name="fam" --name="gujarat land"
...
writeFileSync(join(ROOT, 'wa/participants.json'), JSON.stringify(out, null, 1));
console.log('\n→ wa/participants.json');
process.exit(0);
