...
// tools/ejamin/test/fixtures/homepage.html). Corrected here rather than guessed.
const TYPES = [
...
async function main() {
  ...
  //   EJAMIN_VILLAGE_DISTRICTS='all' node tools/ejamin/scrape-catalog.mjs
  //   EJAMIN_VILLAGE_DISTRICTS='Kheda,Anand,Vadodara' node tools/ejamin/scrape-catalog.mjs
