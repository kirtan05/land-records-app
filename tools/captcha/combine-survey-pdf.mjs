...
//   node tools/captcha/combine-survey-pdf.mjs               # every output/Bhalej_*/
//   node tools/captcha/combine-survey-pdf.mjs Bhalej_174_P1
...
for (const tok of tokens) {
  ...
  //    (deeds/*.pdf comes from tools/captcha/fetch-deeds.mjs; TIFFs are already converted there)
  if (deedPdfs.length) {
