...
//   node tools/captcha/recon-vf6.mjs
...
writeFileSync(join(ROOT, 'tools/captcha/recon-vf6.json'), JSON.stringify(d, null, 1));
writeFileSync(join(ROOT, 'tools/captcha/recon-vf6.html'), await page.content());
