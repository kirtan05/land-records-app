...
const cat = JSON.parse(readFileSync(REPO+'/data/catalog/survey-catalog.json', 'utf8'));
...
writeFileSync(REPO+'/data/catalog/survey-input.json', JSON.stringify(results, null, 2));
...
writeFileSync(REPO+'/data/catalog/survey-input.csv', csv);
