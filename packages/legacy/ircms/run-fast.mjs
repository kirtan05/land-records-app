...
import { fetchCaseListAjax, processCases, openDetailByKey } from '../../core/scrape.mjs';
import { REPO } from '../../core/repo-root.mjs';

const targets = JSON.parse(readFileSync(REPO+'/data/catalog/survey-input.json', 'utf8')).filter((r) => r.matched);
